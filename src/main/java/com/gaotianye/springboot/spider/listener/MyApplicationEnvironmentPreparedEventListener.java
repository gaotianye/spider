...
/**
 * NO2:spring boot 配置环境事件监听:
 * 执行时间：Springboot 对应Enviroment已经准备完毕，但此时上下文context还没有创建。
 * 补充：在该监听中获取到ConfigurableEnvironment后可以对配置信息做操作，
        ...
        if (mps != null) {
            ...
            while (iter.hasNext()) {
                ...
                logger.info("ps.getName:{};ps.getSource:{};ps.getClass:{}", 
                		ps.getName(), ps.getSource(), ps.getClass());
            }
        }*/
	}
